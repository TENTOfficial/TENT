...
# This script tests that the package mirror at https://snowgem.org/depends-sources/
# contains all of the packages required to build this version of Snowgem.
#
# This script assumes you've just built Snowgem, and that as a result of that
...
MIRROR_URL_DIR="https://snowgem.org/depends-sources/"
