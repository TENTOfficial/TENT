...
define $(package)_stage_cmds
  ...
  cp target/release/librustsnowgem.a $($(package)_staging_dir)$(host_prefix)/lib/ && \
  cp include/librustsnowgem.h $($(package)_staging_dir)$(host_prefix)/include/
endef
