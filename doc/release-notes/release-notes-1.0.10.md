...
ECDSA signatures inside Snowgem transactions now use validation using
...
Daira Hopwood (8):
      ...
      Delete test that is redundant and inapplicable to Snowgem.
...
Jack Grigg (20):
      ...
      Hold an ECCVerifyHandle in snowgem-gtest
