...
} // end namespace `libsnowgem`

typedef libsnowgem::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH, libsnowgem::SHA256Compress> ZCIncrementalMerkleTree;
typedef libsnowgem::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libsnowgem::SHA256Compress> ZCTestingIncrementalMerkleTree;

typedef libsnowgem::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH, libsnowgem::SHA256Compress> ZCIncrementalWitness;
typedef libsnowgem::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libsnowgem::SHA256Compress> ZCTestingIncrementalWitness;
