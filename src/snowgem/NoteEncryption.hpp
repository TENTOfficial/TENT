/*
See the Snowgem protocol specification for more information.
https://github.com/snowgem/zips/blob/master/protocol/protocol.pdf
*/
...
typedef libsnowgem::NoteEncryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteEncryption;
typedef libsnowgem::NoteDecryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteDecryption;

typedef libsnowgem::PaymentDisclosureNoteDecryption<ZC_NOTEPLAINTEXT_SIZE> ZCPaymentDisclosureNoteDecryption;
