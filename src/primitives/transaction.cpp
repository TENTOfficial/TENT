...
JSDescription::JSDescription(ZCJoinSplit& params,
            ...
            const boost::array<libsnowgem::JSInput, ZC_NUM_JS_INPUTS>& inputs,
            const boost::array<libsnowgem::JSOutput, ZC_NUM_JS_OUTPUTS>& outputs,
            CAmount vpub_old,
            CAmount vpub_new,
            bool computeProof,
...
{
    boost::array<libsnowgem::Note, ZC_NUM_JS_OUTPUTS> notes;
