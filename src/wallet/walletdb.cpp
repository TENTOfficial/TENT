...
bool CWalletDB::WriteCryptedZKey(const libsnowgem::PaymentAddress & addr,
...
bool CWalletDB::WriteZKey(const libsnowgem::PaymentAddress& addr, const libsnowgem::SpendingKey& key, const CKeyMetadata &keyMeta)
{
    nWalletDBUpdated++;
...
bool CWalletDB::WriteViewingKey(const libsnowgem::ViewingKey &vk)
{
    nWalletDBUpdated++;
    return Write(std::make_pair(std::string("vkey"), vk), '1');
}

bool CWalletDB::EraseViewingKey(const libsnowgem::ViewingKey &vk)
{
    nWalletDBUpdated++;
             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
    try {
        ...
        {
            libsnowgem::PaymentAddress addr;
            ssKey >> addr;
        ...
        else if (strType == "czkey")
        {
            ...
            uint256 rkValue;
            ssValue >> rkValue;
            libsnowgem::ReceivingKey rk(rkValue);
